...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.2.14-blue?style=flat-square" alt="version 0.2.14"/>
...
docker pull ghcr.io/agjs/voicebox:0.2.14
docker run --rm -p 127.0.0.1:8790:8790 ghcr.io/agjs/voicebox:0.2.14
...
# or pull a release tag: ghcr.io/agjs/voicebox:0.2.14-cuda
```
